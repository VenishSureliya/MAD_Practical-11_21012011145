...
import com.example.mad_practical_11_21012011145.Contact
import com.example.mad_practical_11_21012011145.PersonDbTableData
...
class DatabaseHelper(context: Context?) :
    ...
    fun insertPerson(person: Contact): Long {
    ...
    private fun getValues(person: Contact): ContentValues {
    ...
    fun getPerson(id: String): Contact? {
    ...
    private fun getPerson(cursor: Cursor): Contact {
        return Contact(
    ...
    // Select All Query
    val allPersons: ArrayList<Contact>
        get() {
            val persons = ArrayList<Contact>()
            // Select All Query
    ...
    fun updatePerson(person: Contact): Int {
        val db = this.writableDatabase
        // updating row
        return db.update(
            PersonDbTableData.TABLE_NAME,
    ...
    fun deletePerson(person: Contact) {
        val db = this.writableDatabase
        db.delete(
            PersonDbTableData.TABLE_NAME,
            PersonDbTableData.COLUMN_ID + " = ?",
